      ...
      <AnimatePresence>
        {open && (
          <motion.span
            ...
            className={`pointer-events-none absolute z-[60] whitespace-nowrap rounded-full border border-border-strong bg-fg/[0.08] px-3.5 py-1.5 font-sans text-[0.5625rem] uppercase tracking-[0.18em] text-fg shadow-[inset_0_1px_0_0_rgba(255,255,255,0.18),0_10px_30px_-12px_rgba(0,0,0,0.6)] backdrop-blur-xl ${
              side === "left"

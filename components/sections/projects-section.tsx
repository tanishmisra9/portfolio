    ...
    <section id="projects" className="scroll-mt-20 pb-8 pt-6 md:pb-16 md:pt-11">
      <div className="mx-auto w-full max-w-7xl px-8 md:px-16 lg:px-32">
        <ScrollReveal variant="fade">
          <h2 className="mb-8 select-none font-display text-[10vw] font-extrabold uppercase leading-none tracking-tighter text-[var(--heading-ghost)] [text-shadow:0.55px_0_0_currentColor,-0.55px_0_0_currentColor] md:mb-12">
            PROJECTS
          </h2>
        </ScrollReveal>
